...
function chartCourse(information){
    ...
    for(let i = 0; i < information.length; i++){
        ...
        if(information[i].includes("forward")){
            xAxis += Number(information[i][information[i].length -1 ]);
        }
